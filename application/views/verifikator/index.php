						...
						<div class="table-responsive">
							...
							<tbody>
								...
								<tr>
									...
									if($value->layanan_id == 9 || $value->layanan_id == 10 || $value->layanan_id == 11 || $value->layanan_id == 14 || $value->layanan_id == 20)
									{
									...
									<?php 
									//jika layanan KARPEG/KARIS/KARSU/PENCATUMAN GELAR/PEREMAJAAN DATA main dokumen dari pengantar
									if($value->layanan_id == 9 || $value->layanan_id == 10 || $value->layanan_id == 11 || $value->layanan_id == 14 || $value->layanan_id == 20)
									{	
