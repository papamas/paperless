  ...
  <div class="wrapper">	
	...
	$(document).ready(function () {
		...
		$('#pengantarModal').on('show.bs.modal',function(e) {    		
			...
			var iframe = $('#frame');
			iframe.attr('src', '<?php echo site_url()?>'+'/usul/getInline/'+id);			
	    });
		
		$('a[href="#dExcel"]').click(function(){
			var id= this.id;
		     document.location = "<?php echo site_url()?>/usul/getExcel/"+id;
		}); 

		$('a[href="#dPdf"]').click(function(){
			var id= this.id;
		     document.location  = "<?php echo site_url()?>/usul/getPdf/"+id;
		}); 
		
		$('#pengantarModalTaspen').on('show.bs.modal',function(e) {    		
			var id=  $(e.relatedTarget).attr('data-id');
			var iframe = $('#pengantarModalTaspen #frame');
			iframe.attr('src', '<?php echo site_url()?>'+'/usul/getInlineTaspen/'+id);			
	    });
		
		$('a[href="#dExcelTaspen"]').click(function(){
			var id= this.id;
		     document.location = "<?php echo site_url()?>/usul/getExcelTaspen/"+id;
		}); 

		$('a[href="#dPdfTaspen"]').click(function(){
			var id= this.id;
		     document.location  = "<?php echo site_url()?>/usul/getPdfTaspen/"+id;
		}); 
